    ...
    <div class="mx-auto w-full max-w-6xl">
      <section class="bg-white border border-neutral-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12">
          ...
          <!-- Top info bar -->
          <div class="col-span-1 md:col-span-2 border-b border-neutral-300 md:border-r px-6 py-5">
            <div class="w-full">
              <svg data-v-79e92f9e="" width="120" height="51" viewBox="0 0 120 51" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
